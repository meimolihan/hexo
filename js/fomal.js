...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | 凡凡小站")[0];
}
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by 凡凡小站 %c 你正在访问凡凡の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 凡凡小站") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('凡凡的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
// 必应每日壁纸API
let bingDayBg = screen.width <= 768 ? "url(https://bingw.jasonzeng.dev)" : "url(https://bingw.jasonzeng.dev)";
// 必应历史壁纸API
let bingHistoryBg = screen.width <= 768 ? "url(https://api.timelessq.com/bing/random)" : "url(https://api.timelessq.com/bing/random)";
// EEE.DOG
let EEEDog = "url(https://acg.suyanw.cn/beauty)";
// 随机美图cdn.seovx.com
...
//  小歪高清壁纸
let waiBizhi = "url(http://api.btstu.cn/sjbz/?lx=meizi)";
// 博天随机
...
let unsplash = "url(https://api.zylearning.top/api/wallpaper?lx=mnmt)";
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://file.meimolihan.eu.org/hexo/default-bg.png);
    --darkmode-bg: url(https://file.meimolihan.eu.org/hexo/darkmode-bg.webp);
    --mobileday-bg: url(https://file.meimolihan.eu.org/hexo/mobileday-bg.png);
    --mobilenight-bg: url(https://file.meimolihan.eu.org/hexo/mobilenight-bg.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<a class="swf" id="swf_LXGW" href="javascript:;" rel="noopener external nofollow" style="font-family:'LXGW'!important;color:black" onclick="setFont('LXGW')">小石头</a>
...
<a class="swf" id="swf_MiSans" href="javascript:;" rel="noopener external nofollow" style="font-family:'MiSans'!important;color:black" onclick="setFont('MiSans')">珠海体</a>
...
<h3>1. 随机二次元</h3>
<details class="folding-tag" cyan><summary> 查看随机二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://acg.suyanw.cn/Anime)" class="imgbox" onclick="changeBg('url(https://acg.suyanw.cn/Anime)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://api.luvying.com/acgimg)" class="imgbox" onclick="changeBg('url(https://api.luvying.com/acgimg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://t.alcy.cc/ycy)" class="imgbox" onclick="changeBg('url(https://t.alcy.cc/ycy)')"></a><!--<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://t.alcy.cc/moez)" class="imgbox" onclick="changeBg('url(https://t.alcy.cc/moez)')"></a>--><!--<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://api.paugram.com/wallpaper/?source=sm)" class="imgbox" onclick="changeBg('url(https://api.paugram.com/wallpaper/?source=sm)')"></a>--><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://t.alcy.cc/pc)" class="imgbox" onclick="changeBg('url(https://t.alcy.cc/pc)')"></a><!--<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://api.paugram.com/wallpaper/)" class="imgbox" onclick="changeBg('url(https://api.paugram.com/wallpaper/)')"></a>--><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://t.alcy.cc/ysz)" class="imgbox" onclick="changeBg('url(https://t.alcy.cc/ysz)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://file.meimolihan.eu.org/wallpaper/sj-001.webp)" class="pimgbox" onclick="changeBg('url(https://file.meimolihan.eu.org/wallpaper/sj-001.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://file.meimolihan.eu.org/wallpaper/sj-002.webp)" class="pimgbox" onclick="changeBg('url(https://file.meimolihan.eu.org/wallpaper/sj-002.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://file.meimolihan.eu.org/wallpaper/sj-003.webp)" class="pimgbox" onclick="changeBg('url(https://file.meimolihan.eu.org/wallpaper/sj-003.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://file.meimolihan.eu.org/wallpaper/sj-004.webp)" class="pimgbox" onclick="changeBg('url(https://file.meimolihan.eu.org/wallpaper/sj-004.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://file.meimolihan.eu.org/wallpaper/sj-005.webp)" class="pimgbox" onclick="changeBg('url(https://file.meimolihan.eu.org/wallpaper/sj-005.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://file.meimolihan.eu.org/wallpaper/sj-006.webp)" class="pimgbox" onclick="changeBg('url(https://file.meimolihan.eu.org/wallpaper/sj-006.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://file.meimolihan.eu.org/wallpaper/sj-007.webp)" class="pimgbox" onclick="changeBg('url(https://file.meimolihan.eu.org/wallpaper/sj-007.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://file.meimolihan.eu.org/wallpaper/sj-008.webp)" class="pimgbox" onclick="changeBg('url(https://file.meimolihan.eu.org/wallpaper/sj-008.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://file.meimolihan.eu.org/wallpaper/sj-009.webp)" class="pimgbox" onclick="changeBg('url(https://file.meimolihan.eu.org/wallpaper/sj-009.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://file.meimolihan.eu.org/wallpaper/sj-010.webp)" class="pimgbox" onclick="changeBg('url(https://file.meimolihan.eu.org/wallpaper/sj-010.webp)')"></a></div>
              </div>
            </details>
